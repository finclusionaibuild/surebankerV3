  ...
  const demoAccounts = [
    {
      ...
      role: "Customer (Individual Account)",
      description: "Regular individual banking customer with access to personal dashboard",
      icon: <UserIcon className="w-6 h-6" />,
      bgColor: "bg-blue-100",
      iconColor: "text-blue-600",
      badgeColor: "bg-blue-500",
      route: "/dashboard",
      features: ["Personal Dashboard", "Transactions", "Cards Management", "Payments", "SureSavings", "SureBudget"]
    },
    {
      id: "business",
      name: "Atinse Enterprises",
      email: "business@atinse.com",
      role: "Customer (Business Account)",
      description: "Business banking customer with access to business dashboard and features",
      icon: <BuildingIcon className="w-6 h-6" />,
      bgColor: "bg-teal-100",
      iconColor: "text-teal-600",
      badgeColor: "bg-teal-500",
      route: "/business-dashboard",
      features: ["Business Dashboard", "Multi-user Access", "Business Transactions", "Vendor Payments", "Payroll Management"]
    },
    {
      id: "admin",
      name: "John Admin",
    ...
    },
    {
      ...
      role: "Super Admin",
      description: "Full platform access with system configuration and feature flags",
      icon: <CrownIcon className="w-6 h-6" />,
      bgColor: "bg-purple-100",
      iconColor: "text-purple-600",
      badgeColor: "bg-purple-500",
      route: "/super-admin",
      features: ["Platform Overview", "Feature Flags", "API Management", "System Health", "Security Center"]
    },
    {
      id: "support",
      name: "Mike Support",
    ...
    },
    {
      ...
      description: "Advanced fintech capabilities for developers testing integrations and API usage",
      icon: <CodeIcon className="w-6 h-6" />,
      bgColor: "bg-indigo-100",
      iconColor: "text-indigo-600",
      badgeColor: "bg-indigo-500",
      route: "/developer-dashboard",
      features: ["API Management", "Sandbox Environment", "Webhook Testing", "OAuth Management", "Mock Data Generator"]
    }
  ];
