...
import { ArrowLeftIcon, ArrowRightIcon, CheckIcon, BuildingIcon, UserIcon, MapPinIcon, PhoneIcon, MailIcon, CalendarIcon, ShieldIcon, EyeIcon, EyeOffIcon } from "lucide-react";
...
export const BusinessOnboarding = (): JSX.Element => {
  ...
  const relationships = [
    'Spouse', 'Parent', 'Child', 'Sibling', 'Business Partner', 'Friend', 'Other'
  ];
  ...
  const handleNext = () => {
    if (currentStep < 4) {
      ...
      // Complete onboarding and redirect to business dashboard
  ...
  const renderStep1 = () => (
    <div className="max-w-lg mx-auto">
      <div className="text-center mb-8">
        <BuildingIcon className="w-16 h-16 text-[#5B52FF] mx-auto mb-4" />
        <h2 className="text-2xl font-bold text-[#1E293B] mb-2">Quick Business Onboarding</h2>
  ...
  const renderStep4 = () => (
    <div className="max-w-lg mx-auto text-center">
      <div className="mb-8">
        ...
        <p className="text-[#64748B]">Your business account has been created with restricted access</p>
      </div>
      ...
      <Card className="bg-yellow-50 border-yellow-200 mb-8">
        <CardContent className="p-6">
          ...
          <p className="text-sm text-yellow-700 mb-4">
            Your account currently has limited access. To unlock full business features, please complete your KYB verification.
          </p>
          <div className="text-left space-y-2">
            ...
            <p className="text-xs text-yellow-600">✗ Full money transfers (requires KYB Tier 3)</p>
            <p className="text-xs text-yellow-600">✗ Payroll features (requires KYB Tier 3)</p>
            <p className="text-xs text-yellow-600">✗ Bulk payments (requires KYB Tier 3)</p>
            <p className="text-xs text-yellow-600">✗ POS integration (requires KYB Tier 3)</p>
            <p className="text-xs text-yellow-600">✗ Business loans (requires KYB Tier 3)</p>
          </div>
        </CardContent>
      </Card>
